...
class GenerateWordLists extends Command
{
    ...
    public function generateTopicWordList($topic)
    {
        ...
        $jsonResult = $this->chatGPTRequest->ask("Please split at least 30 Finnish words for topic \"" . $topic['topic'] . "\" to ". $levelsString ." and share me a result with translations as a json string. For the JSON template please use " . $this->getJsonTemplate());
        //print $jsonResult;
